...
public class Laptop extends Computer
{
    ...
    public Laptop(String manufacturer, String cpu, int ram_size, int disk_size, double weight, String asset_tag, LocalDateTime purchase_date, int screen_size, double battery_life) {
